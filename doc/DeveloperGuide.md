...
2. AddressBook shows a list of persons with user inputted tag
3. AddressBook requests for confirmation from user to rename tag
4. User confirms to rename tag
5. AddressBook renames tag for list of persons <br>
Use case ends.

**Extensions**

2a. No persons has the tag

 > 2a1. AddressBook shows errro message <br>
   Use case ends

4a. User cancels confirmation
